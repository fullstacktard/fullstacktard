<template>
  <div
    id="vanta-bg"
    class="flex flex-col items-center h-screen justify-center w-screen home font-Unison z-0 overflow-x-hidden"
  >
    <div
    ...
    >
      ...
      <div class="flex flex-col items-center justify-center rounded-full">
        ...
        <three-column :items="items">
          <template #item="{ index }">
            <div
              class="flex flex-col items-center text-white w-full h-full px-4"
            >
              <div class="flex justify-center w-full items-center">
                ...
                />
                <div>
                  <h2 class="text-2xl font-bold">{{ items[index].title }}</h2>
              ...
              <div class="flex gap-4 mt-4">
                <a
                  ...
                  :key="i"
                  :href="link.url"
                  class="hover:text-[#00ff00] transition-colors"
                >
                  <font-awesome-icon
    ...
    <div
      class="absolute bottom-4 grid grid-cols-3 gap-4 text-white text-2xl z-[2]"
    >
      <a
    ...
    const items = [
      {
        ...
        links: [
          { icon: "globe", url: "https://unitszero.one" },
