...
### [claude-workflow](https://www.npmjs.com/package/claude-workflow)

automated Claude Code configuration setup for existing projects. templating system that actually works
